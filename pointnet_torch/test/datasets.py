...
class PartDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        print(f"self.datapath[index]: {self.datapath[index]}")
        fn = self.datapath[index]
        cls = self.classes[self.datapath[index][0]]
        
        # # Open3D to numpy
        # pcd_load = open3d.io.read_point_cloud("../../TestData/sync.pcd")
        ...
        print(f"point_set: {point_set}, point_set.shape: {point_set.shape}")
        print(f"seg: {seg}, seg.shape: {seg.shape}")
